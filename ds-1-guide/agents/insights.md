...
Each topic group shows the actual keywords behind it, so you can see whether the grouping holds up before you act on it. See [Build a search LAL audience](build-a-search-term-seeded-audience.md) for what happens next.
...
Pick a pixel and it opens in **Explore**, a set of views you toggle between in the left sidebar. See [Create a pixel](create-a-pixel.md) if you do not have one collecting yet.

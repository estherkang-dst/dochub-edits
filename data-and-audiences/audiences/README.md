...
1. **Choose a seed.** Start with the signal that best represents your target customer.
2. **Build the model.** Dstillery identifies similar patterns at scale.
3. **Activate.** Deliver the audience through your buying platform.

Pre-built Audiences skip modeling and activate directly.

### Activate with the right control
